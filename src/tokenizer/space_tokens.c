...
/*   Updated: 2024/10/24 12:21:02 by artuda-s         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * If there is something after the redir adds a space and turns the space flag off
*/
...
char    *ft_space_tokens(char *str)
{
	...
	while(str && str[i] && flag != ERROR)
	{
        ...
        {
            nstr = ft_append_char_to_str(nstr, str[i++]); // TODO NULL CHECK return (NULL) solution. removal of i with passing **
            flag = true;
        }
    }
    return (nstr);
