...
/*   Updated: 2024/11/21 13:46:04 by artuda-s         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * quote char is found. If none is found and the string ends returns
 *  (open quote flag)
 */
...
/**
 *	@brief	Checks for pipe at the beggining, the double redir token
 * or redir token at the end (> >> < << |)
 *
...
/**
 * @brief	Will basically check for open quotes, redirecs at the 
 * end, pipe at the start
